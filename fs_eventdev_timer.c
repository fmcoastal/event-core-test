...
void evt_time_dev_print_setup(void);
void evt_time_dev_print_setup(void)
{
printf("\n"
"  ---------------          ------------                                     \n"
...
int        evt_time_dev_setup( __attribute__((unused))void * arg);
int         evt_time_dev_loop( __attribute__((unused))void * arg);
int        evt_time_dev_print( __attribute__((unused))void * arg);
int      evt_time_dev_cleanup( __attribute__((unused))void * arg);
void evt_time_dev_description( void);
